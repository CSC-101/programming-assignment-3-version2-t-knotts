...
class TestCases(unittest.TestCase):
    ...
    def test_population_total(self):
        expected = 318857056
        result = hw3.population_total(build_data.get_data())
        self.assertEqual(expected,result)

    # Part 2
    def test_filter_by_state(self):
        expected = 58
        result = len(hw3.filter_by_state(build_data.get_data(),"CA"))
        self.assertEqual(expected,result)
    ...
    def test_education_greater_than(self):
        ...
        {'2010 Population': 200849,
         ...
         'Population per Square Mile': 197.9},
        'CA')]
        result = hw3.education_greater_than(reduced_data,"Bachelor's Degree or Higher",.3)
        self.assertEqual(expected,result)
    ...
    def test_education_less_than(self):
        ...
        {'2010 Population': 61948,
         ...
         'Population per Square Mile': 104.4},
        'AR')]
        result = hw3.education_less_than(reduced_data,"Bachelor's Degree or Higher", .15)
        self.assertEqual(expected,result)
    ...
    def test_ethnicity_greater_than(self):
        ...
        {'2010 Population': 200849,
         ...
         'Population per Square Mile': 197.9},
        'CA')]
        result = hw3.ethnicity_greater_than(reduced_data,"Two or More Races",.04)
        self.assertEqual(expected,result)
    ...
    def test_ethnicity_less_than(self):
        ...
        {'2010 Population': 54571,
         ...
         'Population per Square Mile': 91.8},
        'AL')]
        result = hw3.ethnicity_less_than(reduced_data,"Two or More Races",.0185)
        self.assertEqual(expected,result)
    ...
    def test_below_poverty_level_greater_than(self):
        ...
        {'2010 Population': 61948,
         ...
         'Population per Square Mile': 104.4},
        'AR')]
        result = hw3.below_poverty_level_greater_than(reduced_data,.2)
        self.assertEqual(expected,result)
    ...
    def test_below_poverty_level_less_than(self):
        ...
        {'2010 Population': 7208,
         ...
         'Population per Square Mile': 3.0},
        'WY')]
        result = hw3.below_poverty_level_less_than(reduced_data,.12)
        self.assertEqual(expected,result)
